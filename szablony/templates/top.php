...
<head>
    ...
    <title><?php out($page_title); if (!isset($page_title)) {  ?> Proste szablony <?php } ?></title>
...
<div id="app_top" class="header">
    <div class="home-menu pure-menu pure-menu-open pure-menu-horizontal pure-menu-fixed">
        <a class="pure-menu-heading" href=""><?php out($page_title); if (!isset($page_title)) {  ?> Strona z szablonem <?php } ?></a>
        <ul>
...
<div class="splash-container">
    <div class="splash">
        <h1 class="splash-head"><?php out($page_header); if (!isset($page_header)) {  ?> Proste szablony <?php } ?></h1>
